...
bot = telebot.TeleBot("1399782659:AAETzUF8L_NmGwZR3DhbAA3AVuFbk1oKXzE")
...
Например: `angular, vue, react ...`""", parse_mode="Markdown", reply_markup=naz())
            ...
            bot.edit_message_text(chat_id=call.message.chat.id, message_id=call.message.message_id , text="Это секрет :)", parse_mode="Markdown", reply_markup=naz())
